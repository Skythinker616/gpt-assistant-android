**简体中文 | [English](template_help_en.md)**
...
| `@agent` | `true`或`false` | 是否开启智能体模式（实验性，需先开启对应无障碍服务） |
...
- 如果设置了`@model`、`@speak`、`@network`、`@chat`、`@agent`参数，在选中该模板时，对应的软件全局设置将会暂时被覆盖
